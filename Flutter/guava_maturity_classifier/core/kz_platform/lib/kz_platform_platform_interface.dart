...
abstract class KzPlatformPlatform extends PlatformInterface {
  /// Constructs a KzPlatformPlatform.
  ...
  /// The default instance of [KzPlatformPlatform] to use.
  ///
  /// Defaults to [MethodChannelKzPlatform].
  static KzPlatformPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [KzPlatformPlatform] when
